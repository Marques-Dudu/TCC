...
public class TelaLogin extends AppCompatActivity {
    ...
    //variavel auxiliar Progress bar
    int i = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Mostrando senha caso o usúario queira
        btMostarSenha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (editSenha.getInputType() == 129){ //129 é o código para EditText de Password (senha)
                    btMostarSenha.setImageResource(R.drawable.olho);
                    editSenha.setInputType(1); // 1 é o código para "textVisiblePassword"
                }
                else {
    ...
    private void TelaPrincipal(){
        Intent intent = new Intent(TelaLogin.this , activity_tela_principal.class);
