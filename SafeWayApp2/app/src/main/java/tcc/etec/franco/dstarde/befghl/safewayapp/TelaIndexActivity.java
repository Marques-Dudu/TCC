...
public class TelaIndexActivity extends AppCompatActivity {
    ...
    public void getLocation(){
        ...
        // O metodo utilizado ja foi descontinuado, porem como o minSDK do app e 25, a maneira compativel de fazer e esta
        RequisicaoLocation = LocationRequest.create()
                ...
                .setInterval(10000) // Define o intervalo em que o app ira pegar a localizacao do usuario (milisegundos)
                .setFastestInterval(5000) // Define o intervalo minimo que o app pode pegar a localizacao do usuario
                .setPriority(Priority.PRIORITY_HIGH_ACCURACY); // Define que a localizacao sera pega via GPS

                // Configurando a chegada da localizacao
                    ...
                    public void onLocationResult(@NonNull LocationResult locationResult) {
                        ...
                        if(locationResult != null){
                            ...
                            double lon = localizacao.getLongitude();
                                Log.i(null, "Localizacao -> " + "Latitude: " + lat + " Longitude: " + lon + ".");

                                Toast.makeText(TelaIndexActivity.this, "Latitude: " + lat + ", Longitude: " + lon + ".", Toast.LENGTH_SHORT).show();
